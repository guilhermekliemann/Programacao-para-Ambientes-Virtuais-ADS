...
public class Exercicio07 {
    ...
    private static void ordenaPorValor() {
    ...
    private static void ordenaPorNome() {
    ...
    private static void adicionarValor() {
        ...
        for(int i=0; i<listaProduto.size(); i++) {
            if(listaProduto.get(i).getNomeProduto().equalsIgnoreCase(nomeProduto)) {
    ...
    private static void listarItensCompra() {
